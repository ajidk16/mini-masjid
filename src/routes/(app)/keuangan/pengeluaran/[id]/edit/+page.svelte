...
<svelte:head>
	<title>Edit Pengeluaran | Keuangan | MiniMasjid</title>
</svelte:head>
...
<div class="max-w-2xl mx-auto space-y-6">
	...
	<div class="flex items-center gap-4">
		...
		<div>
			<h1 class="text-2xl font-bold">✏️ Edit Pengeluaran</h1>
			<p class="text-base-content/60">Perbarui data transaksi pengeluaran</p>
		</div>
	</div>
	...
	>
		<div class="card-body space-y-4">
			...
			<div class="flex justify-between pt-4 border-t border-base-200">
				<a
					href="/keuangan/pengeluaran/{data.transaction?.id}/delete"
